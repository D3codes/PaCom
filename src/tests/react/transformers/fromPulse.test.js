...
import { InvalidInputError } from '../../../react/exceptions';
...
const expectedTransform = '[{"patient":{"accountNumber":"12345-67","name":"Freeman, David D","contactMethods":[{"phoneNumber":"(913)705-0325","type":"Phone"},'
                        ...
                        + '"name":"Sasnett, Caullen R","contactMethods":[{"phoneNumber":"(913)683-8736","type":"Phone"},{"phoneNumber":"(913)683-8736","type":"Cell"}],'
...
describe('fromPulse', () => {
	...
	it('throws an InvalidInputError if called with falsy data', () => {
		expect(() => { fromPulse(undefined); }).toThrow(InvalidInputError);
		expect(() => { fromPulse(null); }).toThrow(InvalidInputError);
		expect(() => { fromPulse(''); }).toThrow(InvalidInputError);
	});
});
